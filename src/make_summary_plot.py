"""
Generate the final pipeline summary figure for the PHY 305 presentation.

Four-panel layout:
  (a) Density field evolution (z=5.4 vs z=0)
  (b) P(k) evolution showing BAO degradation
  (c) Pre/post reconstruction P(k)/P_nw ratio
  (d) MCMC α posteriors: old 3-param vs broadband-marginalized
"""
import sys, os
...
# ---- Panel (a): Density field z=5.4 and z=0 ----
...
# Use a single axis with two images pasted side by side
...
# ---- Panel (c): P(k)/P_nw ratio (BAO wiggles) ----
...
# Bin the ratios for clarity (running mean in groups of ~5)
